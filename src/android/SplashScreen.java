...
public class SplashScreen extends CordovaPlugin {
    ...
    private static boolean fadeOutAnimationInProgress = false;
    ...
    private synchronized void removeSplashScreen(final boolean forceHideImmediately) {
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                Log.d('app', 'using updated splash screen');
                if (splashDialog != null && splashDialog.isShowing()) {
                    final int fadeSplashScreenDuration = getFadeDuration();
                    // CB-10692 If the plugin is being paused/destroyed, skip the fading and hide it immediately
                    if (   fadeSplashScreenDuration > 0
                        && forceHideImmediately == false
                        && !fadeOutAnimationInProgress
                    ) {
                        ...
                        fadeOutAnimationInProgress = true;
                        ...
                        fadeOut.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                if (splashDialog != null && splashDialog.isShowing()) {
                                    ...
                                    fadeOutAnimationInProgress = false;
                                }
                            }
